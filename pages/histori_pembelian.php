                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                        include "koneksi.php";
                        debugger
                        //menampilkan nama produk yang dibeli
                        $produk_dibeli="<ol>";
                      
                        $qry_produk=mysqli_query($conn,"select nama_produk from detail_transaksi dt join produk on produk.id_produk = dt.id_produk join transaksi t on t.id_transaksi = dt.id_transaksi where dt.id_transaksi = 1");
